...
public class LargeTransactionProcessor implements TransactionProcessorStrategy {

    private final TransactionService transactionService;

    @Override
    public void processTransaction(TransactionDto transaction) {
        log.info("Processing large transaction: {} with amount {}", transaction.id(), transaction.amount());
        ...
        try {
            ...
            log.error("Error processing large transaction: {} with amount {}", transaction.id(), transaction.amount(), e);
